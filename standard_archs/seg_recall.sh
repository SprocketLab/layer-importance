...
for run_number in $(seq 1 5); do
    for model in TS ST; do
		...
		for i in 64,3,1 32,3,1 16,3,1 8,3,1 4,3,1 32,7,1 16,7,1 8,7,1 4,7,1 16,15,1 8,15,1 4,15,1 8,31,1 4,31,1; do
...
for run_number in $(seq 1 5); do
    for model in TT; do
		...
		for i in 64,2,0 32,4,0 16,8,0 8,16,0 4,32,0; do
...
for run_number in $(seq 1 5); do
    for model in SS; do
		...
		for i in 64,0,2 32,0,4 16,0,8 8,0,16 4,0,32; do
