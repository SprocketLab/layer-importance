...
colors = {"TF-TF": "blue", "TF-SSM": "orange", "SSM-TF": "green", "SSM-SSM": "red", "TF~nC-TF~nC": "brown"}

colors.update({"hybrid": "green", "TF": "blue", "SSM": "red"})

colors.update({"TF-TF-TF": "blue", "SSM-SSM-SSM": "red", "SSM-SSM-TF": "green", "TF-TF-SSM": "orange", "SSM-TF-SSM": "purple", "TF-SSM-TF": "brown", "SSM-TF-TF": "pink", "TF-SSM-SSM": "gray"})
...
def plot(data, params, ind_var, diff_lines="layers", param_counts=None, x_axis=None, num_layers=2):
    ...
    if x_axis == 'epochs':
        ...
        for k in data.keys():
            ...
            if diff_lines == "dim":
                if 'layer3' in params.keys():
                    if d["layers"] != params['layer1'] + "-" + params['layer2'] + "-" + params['layer3']: continue
                else:
                    if d["layers"] != params['layer1'] + "-" + params['layer2']: continue
    ...
    if diff_lines == 'layers':
        ...
        for k in data.keys():
            ...
            # if key == "TF-SSM": continue
            # if d['dim'] == 'd48': continue
